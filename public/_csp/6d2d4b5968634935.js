...
lp=lm?'/c-config/'+lm[1]:'/c-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/c-config/'+lm[1]+'/search-index.json':'/c-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
