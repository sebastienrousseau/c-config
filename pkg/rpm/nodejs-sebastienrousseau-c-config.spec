...
%global npm_bare      c-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-c-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable C configuration providing standardized clang-format and clang-tidy rules adhering to modern 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/c-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/c-config is a shareable configuration preset with no runtime
