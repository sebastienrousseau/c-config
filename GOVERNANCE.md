...
This document describes how @sebastienrousseau/c-config is run: who decides what, how
...
@sebastienrousseau/c-config is **maintainer-led**. As of the current release line it has a single
