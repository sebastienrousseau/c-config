...
<p align="center">
  <img src="./c-config.svg" alt="c-config logo" width="128" />
</p>

<h1 align="center">@sebastienrousseau/c-config</h1>
...
<p align="center">
  <a href="https://github.com/sebastienrousseau/c-config/actions"><img src="https://img.shields.io/github/actions/workflow/status/sebastienrousseau/c-config/ci.yml?branch=main&style=for-the-badge&logo=github" alt="Build Status" /></a>
  <a href="https://www.npmjs.com/package/@sebastienrousseau/c-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fc-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/c-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  <a href="https://scorecard.dev/viewer/?uri=github.com/sebastienrousseau/c-config"><img src="https://img.shields.io/ossf-scorecard/github.com/sebastienrousseau/c-config?style=for-the-badge&label=OpenSSF%20Scorecard&logo=openssf" alt="OpenSSF Scorecard" /></a>
...
- [Clang-Format & Clang-Tidy Rules](#clang-format-clang-tidy-rules) — before and after rule comparison
...
Install `@sebastienrousseau/c-config` as a development dependency:

```bash
# npm
npm install --save-dev @sebastienrousseau/c-config

# pnpm
pnpm add -D @sebastienrousseau/c-config

# yarn
yarn add -D @sebastienrousseau/c-config

# bun
bun add -d @sebastienrousseau/c-config
```

### Build from source

```bash
git clone https://github.com/sebastienrousseau/c-config.git
cd c-config
make            # check + test
```
...
- **Target environment**: Optimized for LLVM Clang 18+ / C23.
...
```bash
cp node_modules/@sebastienrousseau/c-config/.clang-format ./.clang-format
cp node_modules/@sebastienrousseau/c-config/.clang-tidy ./.clang-tidy
```

### Or point the tool at the installed file

```bash
clang-format --style=file:node_modules/@sebastienrousseau/c-config/.clang-format -i src/*.c
```
...
`@sebastienrousseau/c-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/c-config` solves this with three deliberate engineering choices:
...
Includes modern C23 formatting, memory access bounds checking, and CERT C coding standards.
...
### After (@sebastienrousseau/c-config Enforced)
...
When maintaining obsolete K&R C or constrained legacy embedded systems incompatible with Clang 18+ toolchains.
